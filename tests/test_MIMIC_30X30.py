...
config_path = Path("/projects/simlai1/Viberank/VibeRank/configs/datasets/mimic_rc.yaml")

dataloader = MIMICRankCentralityDataLoader.from_yaml(config_path)
dataloader.set_fraction_pairs(fraction_pairs=1)
...
for model_cfg in models_to_run:
    ...
    run_id = f"MIMIC_30X30_{run_label}_prop_seq_run"
