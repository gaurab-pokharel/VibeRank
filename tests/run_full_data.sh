...
#SBATCH --gres=gpu:1
#SBATCH --output=logsRC/FullData_llama_vispdat_%j.out
#SBATCH --error=logsRC/FullData_llama_vispdat_%j.err
...
python tests/test_full_data.py
