...
run_id = "Vispdat_deepseek8B_withvulnerability" #datetime.now().strftime("dummy_vispdat_%Y%m%d_%H%M%S")
...
kwargs["prompt_path"] = "/projects/simlai1/Viberank/data/raw/hmls/prompt_vulnerability.txt"
comp = LLMComparator(
    **kwargs,
